...
import { UserCheck, Check, Sparkles, Trash2, CheckCircle2, ArrowRight } from 'lucide-react';
    ...
    <div className="max-w-4xl mx-auto px-4 py-8 space-y-6">
      ...
      <div className="bg-white rounded-2xl p-4 shadow-sm border border-stone-200 flex flex-wrap items-center justify-between gap-3">
        <div className="flex items-center gap-2">
          ...
          <button
            ...
            className="px-3 py-1.5 bg-stone-100 hover:bg-stone-200 text-stone-800 rounded-xl text-xs font-semibold transition-colors flex items-center gap-1"
          >
            <Sparkles className="w-3.5 h-3.5 text-amber-600" /> Select All Common
          </button>
          <button
            onClick={handleClearAll}
            className="px-3 py-1.5 bg-stone-100 hover:bg-stone-200 text-stone-600 hover:text-rose-600 rounded-xl text-xs font-semibold transition-colors flex items-center gap-1"
          >
      ...
      <div className="pt-4 flex justify-end">
        <button
          ...
          className="w-full sm:w-auto px-8 py-3.5 bg-emerald-700 hover:bg-emerald-800 text-white font-extrabold text-sm rounded-2xl shadow-lg shadow-emerald-900/20 flex items-center justify-center gap-2 cursor-pointer transition-all hover:scale-[1.01]"
        >
